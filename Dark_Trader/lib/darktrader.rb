...
#------Méthode pour proposer un calcul pour les tests à effectuer dans les specs---
...
calc_count(method_trader(all_crypto_indice, all_crypto_symbol))
method_trader(all_crypto_indice,all_crypto_symbol)